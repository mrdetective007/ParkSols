		...
		try {
			...
			if (parking_seat > count) {
				addVehicle = statement.executeUpdate(
						"insert into tblvehicle(ParkingNumber,VehicleCompanyname,RegistrationNumber,OwnerName,OwnerContactNumber,Service,status)values('"
								+ ParkingNumber + "','"  + vehcomp + "','" + vehreno + "','"
								+ ownername + "','" + ownercontno + "','"+ service + "','" + status + "')");
			} else {

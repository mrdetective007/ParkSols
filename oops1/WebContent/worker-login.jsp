				...
				<div class="login-form">
					...
					<form action="WorkerLogin" method="post">
						<div class="form-group">
							<label>Username</label> <input class="form-control" type="text" placeholder="Workername" required name="workername">
						</div>
						<div class="form-group">
							<label>Password</label> <input type="password" class="form-control" name="password" placeholder="Password" required>
						</div>
						<div>
							<label class="pull-left"><a href="forgot-password.jsp">Forgot Password</a></label> 
							<label class="pull-right"><a href="worker-register.jsp">Click Here To Register</a></label>
						</div>
						<button type="submit" name="login"
							class="btn btn-warning ">Sign in</button>
					</form>
				</div>
			</div>
		</div>

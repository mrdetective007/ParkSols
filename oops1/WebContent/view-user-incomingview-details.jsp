				...
				<div class="col-lg-12">
							...
							<%
								...
								Connection con = DatabaseConnection.getConnection();
									...
									ResultSet resultset = statement.executeQuery(
											"select * from tblvehicle where OwnerName='" + session.getAttribute("fName") + "' and ParkingNumber='"+parkingNo+"' ");
					...
					<table class="table mb-0">
						...
						%>
							...
							<tr>
								<th>Rating :</th>
								<td><input name="rating" placeholder="out of 5" class="form-control" required></input></td>
							</tr>
							<tr>
								<th>Status :</th>
